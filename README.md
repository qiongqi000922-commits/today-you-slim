...
以下展示图使用模拟数据绘制，仅用于说明功能，不包含真实用户信息。

![今天你瘦了吗功能总览](docs/images/readme-overview.svg)

| 移动端记录 | 社区与管理台 |
| --- | --- |
| ![移动端记录页面展示](docs/images/readme-mobile.svg) | ![社区和管理台展示](docs/images/readme-community-admin.svg) |
